using CalculoSalario3;

namespace CalculadoraDeSalario3Test;

public class CalculadoraDeSalario3UnitTest
{
    [Fact]
    ...
    public void DeveCalcularSalarioParaDBAsComSalarioAbaixoDoLimite()
    {
        ...
        Assert.Equal(2000.0 * 0.75, salario, 0.00001);
    }
    ...
    public void DeveCalcularSalarioParaDBAsComSalarioAcimaDoLimite()
    {
        ...
        Assert.Equal(3000.0 * 0.85, salario, 0.00001);
    }
}
